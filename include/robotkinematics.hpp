...
class RobotKinamatics {
    ...
    //--contructor
    RobotKinamatics(double track_length = 1, double wheel_base = 1, double wheel_radius = 1, double turning_radius = 1, double inner_wheel_heading = 1, double outter_wheel_heading = 1, double inner_wheel_speed = 1, double outer_wheel_speed = 1, double theata_max = 45) : 
