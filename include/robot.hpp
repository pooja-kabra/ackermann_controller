 ...
 */
        ...
        double xldot = 0; // x1 dot-coordinate of Robot in global frame
        double xrdot = 0; // x2 dot-coordinate of Robot in global frame
        double yldot = 0; // y1 dot-coordinate of Robot in global frame
        double yrdot = 0; // y2 dot-coordinate of Robot in global frame
